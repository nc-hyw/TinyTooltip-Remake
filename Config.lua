    ...
    unit = {
        player = {
            ...
            elements = {
                ...
                itemLevelLabel = { enable = true, color = "ffd200", wildcard = "%s:", filter = "none" },
                itemLevel   = { enable = true, color = "itemLevel", wildcard = "%s", filter = "none" },
                ...
                { "levelValue", "itemLevelLabel", "itemLevel", "factionName", "gender", "raceName", "className", "isPlayer", "role", "moveSpeed", },
                { "mount" },
                { "mplusScore" },
                { "zone" },
            },
